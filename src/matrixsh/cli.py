...
def main() -> None:
    ...
    parser.add_argument("--stream", action="store_true", help="Stream output (if supported)")
    ...
    while True:
        ...
        # If it looks like natural language, don't try to execute
        ...
        if not nl:
            ...
            # Real command error (not "command not found") => don't call AI
